...
import static com.patrick.timetableappbackend.model.Year.SECOND;
...
public class DutchTestData implements ApplicationRunner {
  ...
  private static final CourseHours DUITS = new CourseHours("German language", everyYear(0, 2));
  ...
  private void createStudents() {
    createStudentGroup("VWO", FIRST, "a", 30L);
    createStudentGroup("VWO", FIRST, "b", 30L);
    createStudentGroup("VWO", FIRST, "c", 30L);
    createStudentGroup("VWO", FIRST, "d", 30L);

    createStudentGroup("VWO", SECOND, "a", 30L);
    createStudentGroup("VWO", SECOND, "b", 30L);
    createStudentGroup("VWO", SECOND, "c", 30L);
